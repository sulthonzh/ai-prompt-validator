...
// Simple prompt validation logic
...
if (command === 'validate') {
  ...
  if (!prompt) {
    console.log('Usage: node index.js validate "<prompt>" [--json] [--verbose]');
    process.exit(1);
  }
  ...
  if (!prompt) {
    console.log('Usage: node index.js optimize "<prompt>" [--apply] [--interactive]');
    process.exit(1);
  }
...
Usage:
  node index.js validate "<prompt>"        Validate a prompt
  node index.js optimize "<prompt>"        Get optimization suggestions
...
Options for optimize:
  ...
  --interactive Apply optimizations interactively (not implemented yet)

Examples:
  node index.js validate "Write a function to calculate fibonacci numbers"
  node index.js validate "Write good code" --verbose
  node index.js optimize "Write good code"
  node index.js optimize "Write good code" --apply
`);
} else {
