...
export class PromptOptimizer {
  ...
  private getClarityOptimizations(prompt: string): OptimizationSuggestion[] {
    const optimizations: OptimizationSuggestion[] = [];
  ...
  private getLengthOptimizations(prompt: string): OptimizationSuggestion[] {
    const optimizations: OptimizationSuggestion[] = [];
  ...
  private hasFormatSpecified(prompt: string): boolean {
